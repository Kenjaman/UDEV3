...
public class Vehicule {
	...
	public Class<? extends Vehicule> type=this.getClass();
	...
	public Vehicule(String modele, int anneeMod, double prix, String couleur) {
		super();
		this.matricule = refMatricule;
		this.modele = modele;
	...
	public void arreterVehicule() {
		this.demarrer=false;
		System.out.println("La moto s'arrète....");
	}
