...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("+-"+dessiner1ereColones(longueurArticleMax,"-")+"------+--------+-----+---------+");
		for (LigneCommande ligne : maCommande.getLignes()) {
			System.out.printf("| %-"+(5+longueurArticleMax)+"s | %6.2f | %3d | %7.2f |\n", // %7.2f = un réel sur 7 caractère avec 2 chiffre après la virgule
					ligne.getNomArticle(),
					ligne.getPrixUnitaire(),
					ligne.getQuantite(),
					ligne.getPrixLigne());
		}// %-17s = decalage vers la gauche et completion si necessaire de la chaine de caractère avec 17 caractères d'espacement
		System.out.println("+-"+dessiner1ereColones(longueurArticleMax,"-")+"------+--------+-----+---------+");
